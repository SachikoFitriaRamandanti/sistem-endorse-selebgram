...
include 'connect.php';
$no = 1;
$result = mysqli_query($connection, "SELECT A.id_pesan, A.nama_user, A.no_hp, A.email, B.nama, C.foto, C.video, D.makanan, D.fashion, D.skincare FROM  user A LEFT JOIN Selebgram B ON A.id_pesan = B.id_pesan LEFT JOIN jenis_postingan C ON a.id_user = c.id_jenpos LEFT JOIN produk D ON A.id_user=D.id_produk ");
